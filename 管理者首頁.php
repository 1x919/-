                    ...
                    <div class="container">
                        <div class="section news-section">
                                    ...
                                    <div class='card shadow-sm border-0 rounded-lg'>
                                        <div class='card-body d-flex justify-content-between'>
                                            ...
                                            <div class='right-content'>
                                                <a href='update.php?newsid=" . $row['newsid'] . "' class='btn btn-info btn-sm mb-2'>修改</a><br>
                                                <a href='dblink.php?method=delete&newsid=" . $row['newsid'] . "' class='btn btn-danger btn-sm'>刪除</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>";
                            ...
                            <div class="inserttype">
                                <a href="insert1.php" class="btn">新增公告</a>
                            </div>
                        </div>
                        <!-- 實習職缺-->
